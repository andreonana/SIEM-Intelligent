...
from app.modules.correlation.rule_config_service import KNOWN_RULE_NAMES, get_rule_config, get_rule_configs, set_rule_enabled
...
async def get_all_rules(es_client: AsyncElasticsearch = Depends(get_es_client), user: dict = Depends(require_role("analyst"))):
    ...
    """
    configs = await get_rule_configs(es_client)
