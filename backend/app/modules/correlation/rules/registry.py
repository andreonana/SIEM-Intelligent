...
frfom elasticsearch import AsyncElasticsearch
...
from app.modules.correlation.rules.communication_banned import CommunicationBannedRulesRule
from app.modules.correlation.rule_config_service import is_rule_enabled

def get_active_rules(business_hours_config: dict, network_inventory: dict, es_client: AsyncElasticsearch, rule_configs: dict[str, dict],) -> list[CorrelationAlert]:
    """
