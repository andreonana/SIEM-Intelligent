    ...
    return (
        <div className="space-y-6 font-mono text-sm animate-in fade-in duration-300">
            ...
            <div className="flex justify-between items-center border-b border-slate-800 pb-4">
                <div>
                    <span className="text-xs font-bold text-emerald-400 block">// CENTRE D'ORCHESTRATION DES THREATS</span>
                    ...
                    {selectedAlert ? (
                        <div className="bg-[#0f172a] border border-slate-800 rounded-xl p-6 space-y-6 relative overflow-hidden">
                            ...
                            <div className="space-y-4">
                                <span className="text-emerald-400 text-xs font-black block uppercase tracking-wider">// Actions Disponibles (Sélection Manuelle)</span>
