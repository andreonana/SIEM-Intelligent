                ...
                <form onSubmit={handleSubmit} className="space-y-3.5">
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                        <div>
                            ...
                            <input
                                type="datetime-local"
                                value={criteria.start_date ? criteria.start_date.slice(0, 16) : ''}
                                onChange={(e) => updateCriteria({ start_date: e.target.value ? new Date(e.target.value).toISOString() : '' })}
                        ...
                        <div>
                            ...
                            <input
                                type="datetime-local"
                                value={criteria.end_date ? criteria.end_date.slice(0, 16) : ''}
                                onChange={(e) => updateCriteria({ end_date: e.target.value ? new Date(e.target.value).toISOString() : '' })}
                                className="w-full rounded-lg border px-3 py-2 text-sm"
                                style={inputStyle}
                            />
                        </div>
